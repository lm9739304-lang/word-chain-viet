...
const EXTERNAL_DICT = "D:\\tudien.txt";
...
class MergeDictionaries {
  ...
  loadExternalDictionary() {
    console.log("📖 Loading external dictionary from D:\\tudien.txt...");
...
// Tự động đồng bộ từ undertheseanlp/dictionary + D:\\tudien.txt
...
const merger = new MergeDictionaries();
merger.run();
